...
fashion_model_1 = models.Sequential([
    layers.Conv2D(32, (3, 3), activation='relu', input_shape=(28, 28, 1)),
    layers.MaxPooling2D((2, 2)),
    layers.Conv2D(128, (3, 3), activation='relu'),  # 更改过滤器数量
    layers.MaxPooling2D((2, 2)),
    layers.Conv2D(256, (3, 3), activation='relu'),  # 增加卷积层
    layers.Flatten(),
...
# Compile the model
fashion_model_1.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])

# Train the model
fashion_history = fashion_model_1.fit(x_train, y_train, epochs=10, batch_size=64, validation_data=(x_test, y_test))

# Predict on test set
fashion_y_pred = fashion_model_1.predict(x_test)
...
# Save plot
plt.savefig('fashion_mnist_cnn_training1.png')
print("Training process visualization saved as fashion_mnist_cnn_training1.png")
